...
public enum KeywordKey {
	...
	HP("Health points.", "HP"),
	MP("Mana (or special power) points. Spent using spells.", "MP"),
	STAMINA("Physical energy. Spent on intense physical actions."),
	XP("Gained through combat and actions. Used to level up.", "XP"),

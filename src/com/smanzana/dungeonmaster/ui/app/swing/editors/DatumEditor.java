...
import com.smanzana.dungeonmaster.ui.app.swing.editors.fields.GrabListField.GrabFieldCallback;
 ...
 *
 */
public class DatumEditor extends JScrollPane implements DMEditor {
	...
	// TODO DELETEME
	private static class Temp implements EditorDisplayable {
	...
	public DatumEditor(SessionTemplate template, ActionDatumData data) {
		this();

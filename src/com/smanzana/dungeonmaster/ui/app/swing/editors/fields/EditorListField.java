 ...
 * @author Skyler
 */
public class EditorListField<T extends EditorDisplayable> implements ActionListener, EditorField {

	public static interface EditorListEditor extends DMEditor {

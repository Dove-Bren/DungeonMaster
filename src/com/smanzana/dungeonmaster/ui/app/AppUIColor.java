...
public class AppUIColor {
	...
	public static enum Key {
		BASE_BACKGROUND(new Color(48, 46, 48)),
		BASE_FOREGROUND(new Color(170, 177, 173)),
		BASE_NESTED_BACKGROUND(new Color(68, 66, 69)),
		BASE_SYSTEM(new Color(173, 173, 173)),
		BASE_TEXT_BACKGROUND,
		BASE_TEXT_FOREGROUND(new Color(110, 147, 183)),
		;
	...
	private static AppUIColor instance = null;
	
	public static AppUIColor instance() {
		if (instance == null)
			instance = new AppUIColor();
